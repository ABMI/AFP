...
OhdsiRTools::checkUsagePackage("AFPpackage")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/AFPpackage.pdf")
shell("R CMD Rd2pdf ./ --output=extras/AFPpackage.pdf")
...
OhdsiRTools::createRenvLockFile("AFPpackage")
