...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4304092,4139745)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4304092,4139745)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (2009622,42920771,42900494)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (2009622,42920771,42900494)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3009306,42529190)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (3019284,3004563)
...
WHERE C.procedure_date >= DATEFROMPARTS(2010, 1, 1)
AND YEAR(C.procedure_date) - P.year_of_birth >= 18
...
WHERE C.value_as_number > 0.1000
AND C.unit_concept_id in (8985)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (9191,4123508)
-- End Measurement Criteria
